...
public class MenuEntity implements Serializable {
    ...
    private Boolean menuQad2wmsPoOk;
    
    private Boolean menuQad2wmsSoOk;
    
    private Boolean menuQad2wmsWoOk;
    
    private Boolean menuQad2wmsVschOk;
    
    private Boolean menuQad2wmsCschOk;
    
    private Boolean menuQad2wmsMstrOk;
    ...
    public String getMenuCanrun() {
        return menuCanrun;
    }

    public void setMenuCanrun(String menuCanrun) {
        this.menuCanrun = menuCanrun;
    }
    ...
    public Integer getMenuFkey() {
        return menuFkey;
    }

    public void setMenuFkey(Integer menuFkey) {
        this.menuFkey = menuFkey;
    }
    ...
    public Boolean getMenuQad2wmsPoOk() {
        return menuQad2wmsPoOk;
    }

    public void setMenuQad2wmsPoOk(Boolean menuQad2wmsPoOk) {
        this.menuQad2wmsPoOk = menuQad2wmsPoOk;
    }
        
    public Boolean getMenuQad2wmsSoOk() {
        return menuQad2wmsSoOk;
    }

    public void setMenuQad2wmsSoOk(Boolean menuQad2wmsSoOk) {
        this.menuQad2wmsSoOk = menuQad2wmsSoOk;
    }
        
    public Boolean getMenuQad2wmsWoOk() {
        return menuQad2wmsWoOk;
    }

    public void setMenuQad2wmsWoOk(Boolean menuQad2wmsWoOk) {
        this.menuQad2wmsWoOk = menuQad2wmsWoOk;
    }
        
    public Boolean getMenuQad2wmsVschOk() {
        return menuQad2wmsVschOk;
    }

    public void setMenuQad2wmsVschOk(Boolean menuQad2wmsVschOk) {
        this.menuQad2wmsVschOk = menuQad2wmsVschOk;
    }
        
    public Boolean getMenuQad2wmsCschOk() {
        return menuQad2wmsCschOk;
    }

    public void setMenuQad2wmsCschOk(Boolean menuQad2wmsCschOk) {
        this.menuQad2wmsCschOk = menuQad2wmsCschOk;
    }
        
    public Boolean getMenuQad2wmsMstrOk() {
        return menuQad2wmsMstrOk;
    }

    public void setMenuQad2wmsMstrOk(Boolean menuQad2wmsMstrOk) {
        this.menuQad2wmsMstrOk = menuQad2wmsMstrOk;
    }
